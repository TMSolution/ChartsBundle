...
use Flexix\PrototypeControllerBundle\Controller\EntityController;
use Symfony\Component\HttpFoundation\Request;

class DefaultController extends EntityController
{

    public function chartAction(Request $request, $action, $module, $alias, $id)
    {
        return $this->getAction($request, $action, $module, $alias, $id);
    }
